...
// Source: src/database/repository/partner.go
...
// PartnerByCode mocks base method.
func (m *MockPartnerer) PartnerByCode(ctx context.Context, id string) (models.Partner, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PartnerByCode", ctx, id)
	ret0, _ := ret[0].(models.Partner)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// PartnerByCode indicates an expected call of PartnerByCode.
func (mr *MockPartnererMockRecorder) PartnerByCode(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PartnerByCode", reflect.TypeOf((*MockPartnerer)(nil).PartnerByCode), ctx, id)
}
...
func (m *MockPartnerer) PartnerByUsername(ctx context.Context, id string) (models.Partner, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PartnerByUsername", ctx, id)
	ret0, _ := ret[0].(models.Partner)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockPartnererMockRecorder) PartnerByUsername(ctx, id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "PartnerByUsername", reflect.TypeOf((*MockPartnerer)(nil).PartnerByUsername), ctx, id)
}
