...
type OrderPartnerUpdateRequest struct {
	ReferenceID string          `json:"referenceId" bson:"reference_id" example:"1"`
	State       string          `json:"state" bson:"state" example:"order_confirmed"`
	StateTitle  string          `json:"stateTitle" bson:"state_title" example:"order_confirmed"`
...
type FIO struct {
	FirstName  string `json:"firstName" bson:"first_name"  example:"Jon"`
	LastName   string `json:"lastName" bson:"last_name"  example:"Bones"`
	MiddleName string `json:"middleName" bson:"middle_name"  example:"Jones"`
}
