...
// @Router /api/v1/brokers/loan-programs/ [post]
...
// @Router /api/v1/brokers/loan-programs/{code} [put]
...
// @Router /api/v1/brokers/loan-programs/{code} [get]
...
// @Router /api/v1/brokers/loan-programs [get]
