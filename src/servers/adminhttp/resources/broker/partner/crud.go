...
// @Router /api/v1/brokers/partners [post]
func (a resource) newpartner() http.HandlerFunc {
...
// @Failure 429 {object} httperrors.Response
// @Failure 500 {object} httperrors.Response
// @Router /api/v1/brokers/partners/{id} [put]
func (a resource) update() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx := r.Context()
...
// @Failure 429 {object} httperrors.Response
// @Failure 500 {object} httperrors.Response
// @Router /api/v1/brokers/partners/{id} [get]
func (a resource) partner() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx := r.Context()
