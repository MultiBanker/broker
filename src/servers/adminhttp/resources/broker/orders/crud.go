...
// @Router /api/v1/brokers/orders/{id} [get]
func (o resource) order() http.HandlerFunc {
...
// @Failure 500 {object} httperrors.Response
// @Router /api/v1/brokers/orders [get]
func (o resource) orders() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx := r.Context()
		// строим пагинацию
...
// @Failure 429 {object} httperrors.Response
// @Failure 500 {object} httperrors.Response
// @Router /api/v1/brokers/orders/{id} [put]
func (o resource) updateorder() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		ctx := r.Context()
